      ...
      <SideNav expanded={this.state.isVisible}>
        ...
        <SideNav.Nav defaultSelected="home">
          ...
          <NavItem eventKey="students">
            ...
            <Link to="/teacher/lessons" className="text-white nav-item">Lessons</Link>
          </NavItem>
          <NavItem eventKey="groups">
            ...
            <Link to="/teacher/homework" className="text-white nav-link">Homework</Link>
          </NavItem>
...
const TeacherNav = () => {
   ...
   return account && account.type != 'teacher' ? <Navigate to='/' />
